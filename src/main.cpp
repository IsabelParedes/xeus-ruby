...
int main(int argc, char* argv[])
{
    ...
    {
        std::clog << "xruby " << XEUS_RUBY_VERSION  << std::endl;
        return 0;
    }
    ...
    // std* streams. When a user then tries to start a new kernel, xruby
    ...
    using interpreter_ptr = std::unique_ptr<xeus_ruby::interpreter>;
    interpreter_ptr interpreter = interpreter_ptr(new xeus_ruby::interpreter());
